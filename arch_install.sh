...
printf '\033c'
echo "Welcome to ariel's arch installer script"
...
printf '\033c'
cd $HOME
git clone --separate-git-dir=$HOME/.dotfiles https://github.com/arielboutcher/dotfiles.git tmpdotfiles
rsync --recursive --verbose --exclude '.git' tmpdotfiles/ $HOME/
rm -r tmpdotfiles
# dwm: Window Manager
git clone --depth=1 https://github.com/arielboutcher/dwm.git ~/.local/src/dwm
sudo make -C ~/.local/src/dwm install

# st: Terminal
git clone --depth=1 https://github.com/arielboutcher/st.git ~/.local/src/st
sudo make -C ~/.local/src/st install

# dmenu: Program Menu
git clone --depth=1 https://github.com/arielboutcher/dmenu.git ~/.local/src/dmenu
...
git clone --depth=1 https://github.com/arielboutcher/dwmblocks.git ~/.local/src/dwmblocks
